package com.github.shinchven.displaykit;
...
public class DisplayKit {
     ...
     * @return
     */
    public static DisplayMatrix fitWithWidth(int displayWidth, int originalWidth, int originalHeight) {
     ...
     * @return
     */
    public static DisplayMatrix fitWithHeight(int displayHeight, int originalWidth, int originalHeight) {
    ...
    public static class DisplayMatrix {
        ...
        public DisplayMatrix(int width, int height) {
            this.width = width;
            this.height = height;
            Log.i("DisplayMatrix", String.format("%s x %s", String.valueOf(width), String.valueOf(height)));
        }
